 ...
 * </p>
 * <ul>
 *   <li>{@link cas703.impl.carnival.model.Carnival.impl.ActivityImpl#getVolunteer <em>Volunteer</em>}</li>
 *   <li>{@link cas703.impl.carnival.model.Carnival.impl.ActivityImpl#getVisitors <em>Visitors</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ActivityImpl extends NamedElementImpl implements Activity {
	...
	public EList<Visitor> getVisitors() {
		if (visitors == null) {
			visitors = new EObjectWithInverseResolvingEList<Visitor>(Visitor.class, this, CarnivalPackage.ACTIVITY__VISITORS, CarnivalPackage.VISITOR__VISIT);
		}
		return visitors;
	}
