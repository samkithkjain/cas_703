 ...
 * </p>
 * <ul>
 *   <li>{@link carnival.impl.VolunteerImpl#getUid <em>Uid</em>}</li>
 *   <li>{@link carnival.impl.VolunteerImpl#getWork <em>Work</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VolunteerImpl extends ParticipantImpl implements Volunteer {
	 ...
	 */
	@Override
	public EList<Activity> getWork() {
		if (work == null) {
			work = new EObjectWithInverseResolvingEList<Activity>(Activity.class, this, CarnivalPackage.VOLUNTEER__WORK, CarnivalPackage.ACTIVITY__VOLUNTEER);
		}
		return work;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case CarnivalPackage.VOLUNTEER__WORK:
				getWork().clear();
				getWork().addAll((Collection<? extends Activity>)newValue);
				return;
		}
