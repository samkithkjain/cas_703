...
import carnival.diagram.edit.policies.EventItemSemanticEditPolicy;
...
public class EventEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof EventNameTimeEditPart) {
			((EventNameTimeEditPart) childEditPart).setLabel(getPrimaryShape().getFigureEventLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(CarnivalVisualIDRegistry.getType(EventNameTimeEditPart.VISUAL_ID));
	}
