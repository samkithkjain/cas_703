 ...
 * @generated
 */
public class CarnivalDayNameNEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CarnivalDayNameNEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CarnivalParserProvider.getParser(CarnivalElementTypes.CarnivalDay_2003, getParserElement(),
					CarnivalVisualIDRegistry.getType(carnival.diagram.edit.parts.CarnivalDayNameNEditPart.VISUAL_ID));
		}
		return parser;
	}
