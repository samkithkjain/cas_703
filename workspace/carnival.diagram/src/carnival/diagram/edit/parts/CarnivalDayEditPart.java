...
public class CarnivalDayEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CarnivalDayNameNEditPart) {
			((CarnivalDayNameNEditPart) childEditPart).setLabel(getPrimaryShape().getFigureCarnivalDayLabelFigure());
			return true;
		}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(CarnivalVisualIDRegistry.getType(CarnivalDayNameNEditPart.VISUAL_ID));
	}
	...
	*/
	 ...
	 * @generated
	 */
	public class CarnivalDayFigure extends RoundedRectangle {
