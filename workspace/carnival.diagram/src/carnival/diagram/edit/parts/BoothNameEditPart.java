 ...
 * @generated
 */
public class BoothNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public BoothNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CarnivalParserProvider.getParser(CarnivalElementTypes.Booth_3001, getParserElement(),
					CarnivalVisualIDRegistry.getType(carnival.diagram.edit.parts.BoothNameEditPart.VISUAL_ID));
		}
		return parser;
	}
