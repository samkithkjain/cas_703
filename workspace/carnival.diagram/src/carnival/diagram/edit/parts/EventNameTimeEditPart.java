...
public class EventNameTimeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CarnivalParserProvider.getParser(CarnivalElementTypes.Event_3002, getParserElement(),
					CarnivalVisualIDRegistry.getType(carnival.diagram.edit.parts.EventNameTimeEditPart.VISUAL_ID));
		}
		return parser;
	}
