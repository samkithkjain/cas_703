...
public class VolunteerNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CarnivalParserProvider.getParser(CarnivalElementTypes.Volunteer_2002, getParserElement(),
					CarnivalVisualIDRegistry.getType(carnival.diagram.edit.parts.VolunteerNameEditPart.VISUAL_ID));
		}
		return parser;
	}
