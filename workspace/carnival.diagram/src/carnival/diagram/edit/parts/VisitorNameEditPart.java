...
import carnival.diagram.edit.policies.CarnivalTextSelectionEditPolicy;
 ...
 * @generated
 */
public class VisitorNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public VisitorNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new CarnivalTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return CarnivalElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CarnivalParserProvider.getParser(CarnivalElementTypes.Visitor_2001, getParserElement(),
					CarnivalVisualIDRegistry.getType(carnival.diagram.edit.parts.VisitorNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, CarnivalEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
