 ...
 * @generated
 */
public class CarnivalDayItemSemanticEditPolicy extends CarnivalBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public CarnivalDayItemSemanticEditPolicy() {
	...
	*/
	private void addDestroyChildNodesCommand(ICompositeCommand cmd) {
		...
		for (Iterator<?> nit = view.getChildren().iterator(); nit.hasNext();) {
			...
			switch (CarnivalVisualIDRegistry.getVisualID(node)) {
			case CarnivalDayCarnivalDayActivitiesCompartmentEditPart.VISUAL_ID:
				for (Iterator<?> cit = node.getChildren().iterator(); cit.hasNext();) {
					Node cnode = (Node) cit.next();
					switch (CarnivalVisualIDRegistry.getVisualID(cnode)) {
					case BoothEditPart.VISUAL_ID:
						for (Iterator<?> it = cnode.getTargetEdges().iterator(); it.hasNext();) {
							Edge incomingLink = (Edge) it.next();
							if (CarnivalVisualIDRegistry.getVisualID(incomingLink) == VisitorVisitEditPart.VISUAL_ID) {
