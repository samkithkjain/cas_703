 ...
 * @generated
 */
public class VisitorItemSemanticEditPolicy extends CarnivalBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public VisitorItemSemanticEditPolicy() {
		super(CarnivalElementTypes.Visitor_2001);
	}
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (CarnivalVisualIDRegistry.getVisualID(outgoingLink) == VisitorVisitEditPart.VISUAL_ID) {
